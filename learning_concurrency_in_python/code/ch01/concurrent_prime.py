...
# We split our workload from one batch of 10,000 into 10 batches of 1,000 calculations
def executeProc():
    for i in range(1000):
...
def main():
    ...
    # Use the .join() method in order to wait for execution to finish for all of our processes
    for proc in procs:
        proc.join()
